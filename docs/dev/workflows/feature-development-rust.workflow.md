...
description: 11-step feature development workflow for cli and sync-service (Rust) with GitHub integration, modern coverage tools, and automated issue tracking
services: cli, sync-service
stack: Rust 1.70+, ratatui, tokio, notify
